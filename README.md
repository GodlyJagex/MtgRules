# Beginning Phase
  - ## Untap Step  
    - all phased-in permanents with phasing that the active player controls phase out, and all phased-out
...
This turn-based action doesn’t use the stack.
    ...
    - the active player determines which permanents they control will untap. Then they untap
